...
nasc_data = join(de2_path, 'neutral_gas_nacs', 'n_T_1s_ascii', 'data')
datafile = ''.join(['1982365' 'T072500' '_0_DE2_NACS_1S_V01.ASC'])
NACS = open(join(nasc_data, datafile), 'r').readlines()
